 ...
 */
public interface MIRMailerBodyGenerator {
     ...
     * @throws MIRMailerException if an error occurs during mail body generation
     */
    String generateBody(Map<String, String> formData) throws MIRMailerException;
}
